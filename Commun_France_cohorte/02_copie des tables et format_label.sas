...
%Getlib(RAWincl,&path\Base de donnée SAS\RAW\incl);
%Getlib(RAWsuiv,&path\Base de donnée SAS\RAW\suiv);
%Getlib(RAWanap,&path\Base de donnée SAS\RAW\anap);
%Getlib(RAWrel,&path\Base de donnée SAS\RAW\relec);


* Recupere les libnames de travail (vide e ce moment le);
%Getlib(incl,&path\Base de donnée SAS\&ACTUEL\incl);
%Getlib(suiv,&path\Base de donnée SAS\&ACTUEL\suiv);
%Getlib(anap,&path\Base de donnée SAS\&ACTUEL\anap);
%Getlib(stu,&path\Base de donnée SAS\&ACTUEL\stu);
%Getlib(rel,&path\Base de donnée SAS\&ACTUEL\relec);
